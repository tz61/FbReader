...
module axi4_fbreader_to_hdmi_v1_0 #(
    ...
    parameter AUDIO_BGM_SIZE = 32'h3277ec0,
    parameter AUDIO_SFX_SIZE = 32'h1aeaa0,
  ...
  axi4_fbreader_to_hdmi_v1_0_M00_AXI #(
      ...
      .AUDIO_BGM_ADDR(AUDIO_BGM_ADDR),
			.AUDIO_SFX_ADDR(AUDIO_SFX_ADDR),
			.AUDIO_BGM_SIZE(AUDIO_BGM_SIZE),
			.AUDIO_SFX_SIZE(AUDIO_SFX_SIZE),
